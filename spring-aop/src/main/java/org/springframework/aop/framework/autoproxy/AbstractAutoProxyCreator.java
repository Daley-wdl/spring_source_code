...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	public Object postProcessAfterInitialization(@Nullable Object bean, String beanName) {
		if (bean != null) {
			...
			//判断是否是过早暴露的Bean，此概念在IOC解决循环依赖中有提到
	...
	protected Object wrapIfNecessary(Object bean, String beanName, Object cacheKey) {
		...
		// 如果Bean为AOP类的类型，基础设施类不应代理，或者配置了指定 bean 不需要自动代理
		...
		// 扫描所有相关的方法（PointCut 原始方法，就是哪些方法需要被代理）
	 ...
	 * 4）设置要代理的类
	 * 5）子类可以在此函数中进行对 ProxyFactory 的进一步封装
	 * 6）进行获取代理操作
	 *
	 ...
	 * @see #buildAdvisors
	 */
	//specificInterceptors 就是增强们（advisors）
	//targetSource 是 new SingletonTargetSource(bean)
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		// 进行获取代理操作 ProxyFactory#getProxy
