...
final class PostProcessorRegistrationDelegate {
	...
	/**
	 * 对所有的 BeanDefinitionRegistryPostProcessors 、手动注册的 BeanFactoryPostProcessor 以及通过配置文件方式的 BeanFactoryPostProcessor
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		// Finally, invoke all other BeanFactoryPostProcessors, no ordered
